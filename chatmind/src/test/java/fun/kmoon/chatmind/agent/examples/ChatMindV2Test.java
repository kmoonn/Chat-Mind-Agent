package fun.kmoon.chatmind.agent.examples;

import fun.kmoon.chatmind.agent.tools.test.CityTool;
import fun.kmoon.chatmind.agent.tools.test.DateTool;
import fun.kmoon.chatmind.agent.tools.test.WeatherTool;
